  ...
  return (
    <div className="container">
      <nav className="navbar navbar-expand-sm pt-4">
        <div className="logo">
          Test<span className="is-hide-mobile">-News</span>
        </div>
        {/* <svg
          id="logo_white_svg__Ebene_1"
          xmlns="http://www.w3.org/2000/svg"
          x="0"
          y="0"
          viewBox="0 0 245.6 88.2"
          className="logo pb-3"
          style={{ width: "100px" }}
        >
          <path
            class="logo_white_svg__st0"
            fill="#546263"
        ...
        <ul className="flex-row navbar-nav  ml-auto">
          ...
          <li className="nav-item font-weight-600">
            <span role="button" className="nav-link p-2" onClick={logoutUser}>
              Logout
            </span>
          </li>
        </ul>
